...
public class CartManager {
    ...
    public CartManager() {
        ...
        while (true) {
            ...
            System.out.println(Color.P+"╓"+Color.P+"───────────────MY CART───────────────"+Color.P+"╖"+Color.RS);
            System.out.println(Color.P+"║"+Color.RS+"        1. View Cart                 "+Color.P+"║"+Color.RS);
            ...
            System.out.println(Color.P+"║"+Color.RS+"        4. Clear Cart                "+Color.P+"║"+Color.RS);
